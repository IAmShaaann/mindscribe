...
const Item = ({
  ...
  const CheveronIcon = expended ? ChevronDown : ChevronRight;
  ...
  return (
    ...
    >
      ...
      {isSearch && (
        <kbd
          className="ml-auto pointer-events-none inline-flex h-5 items-center gap-1 rounded border bg-muted px-1.5
